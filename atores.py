...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        if self._esta_voando():
            ...
            self._calcular_pocicao_vertical(delta_t)
            self._calcular_pocicao_horizontal(delta_t)
    ...
    def _calcular_pocicao_vertical(self, delta_t):
    ...
    def _calcular_pocicao_horizontal(self, delta_t):
